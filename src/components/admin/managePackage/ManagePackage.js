...
const ManagePackage = () => {
  ...
  const deleteItem = (id) => {
    ...
    if (getConfirmation) {
      fetch("https://pacific-beach-66737.herokuapp.com/deleteProduct?id=" + id)
        .then((res) => res.json())
        .then((data) => {
  ...
  useEffect(() => {
    fetch("https://pacific-beach-66737.herokuapp.com/getPackages")
      .then((res) => res.json())
      .then((data) => setPackages(data));
  }, []);
  return (
    <div>
      <h2 className='display-5 py-5 text-center'>All Product</h2>
