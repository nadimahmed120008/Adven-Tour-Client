...
const AddPackage = () => {
  ...
  const handleAddPackage = () => {
    ...
    if (name == "" || duration == "" || location == "" || cost == "" || img == "" || included == "") {
      ...
      fetch("https://pacific-beach-66737.herokuapp.com/submitPackage", {
        method: "POST",
        ...
        .then((data) => {
          if (data) {
            ...
            window.alert("Error Ocurred. Check your internet connection and try again..");
          }
        });
    }
  };
  ...
  return (
    <div>
      ...
      <div className='bg-light p-5 m-3'>
        ...
        <input id='durationInp' className='form-control mb-3' type='text' placeholder='Warranty Duration' />
        {/* </div> */}
        {/* <div className='d-flex'> */}
